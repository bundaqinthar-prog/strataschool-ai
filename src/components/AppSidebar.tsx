import {
  ...
  LogOut, History, Building2, Compass, PenTool, Eye, Fingerprint, Lightbulb, CalendarRange, BookMarked, MessageCircle, ScanSearch, MessageSquareQuote, FileSpreadsheet, MessageCircleMore,
} from "lucide-react";
...
const tools = [
  ...
  { title: "Konsultasi AI", url: "/konsultasi", icon: MessageCircle },
  ...
  { title: "Strategi Marketing", url: "/marketing-strategy", icon: FileSpreadsheet },
  { title: "WA Marketing", url: "/wa-marketing", icon: MessageCircleMore },
  ...
  { title: "Kalender Implementasi", url: "/implementation-calendar", icon: CalendarRange },
  { title: "Renstra 5 Tahun", url: "/renstra", icon: BookMarked },
