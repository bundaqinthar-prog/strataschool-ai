import {
  ...
  LogOut, History, Building2, Compass, PenTool, Eye, Fingerprint, Lightbulb, CalendarRange, BookMarked, MessageCircle, ScanSearch, MessageSquareQuote, FileSpreadsheet,
} from "lucide-react";
